...
LDP.prototype.put = function (resourcePath, contents, callback) {
  var ldp = this;
  var filePath = utils.uriToFilename(resourcePath, ldp.root);
...
LDP.prototype.get = function (resourcePath, uri, includeBody, callback) {
    var ldp = this;
    var filename = utils.uriToFilename(resourcePath, ldp.root);
...
LDP.prototype.delete = function(resourcePath, callback) {
    var ldp = this;
    var filename = utils.uriToFilename(resourcePath, ldp.root);
    ldp.stat(filename, function(err, stats) {
        if (err) {
