// TODO: This is a CommonJS wrapper. Use ldp-copy.mjs directly once ESM migration is complete.
module.exports = copy
    ...
    request.get(copyFromUri, options)
      ...
      .on('response', function (response) {
        ...
        resourceMapper.mapUrlToFile({ url: copyToUri, createIfNotExists: true, contentType })
          ...
          .catch((err) => {
            debug.handlers('COPY -- mapUrlToFile error: ' + err)
            reject(error(500, 'Could not find target file to copy'))
          })
      })
  })
}
