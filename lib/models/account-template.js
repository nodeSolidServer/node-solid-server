...
class AccountTemplate {
   ...
   */
  static for (userAccount, options = {}, host = {}) {
    let substitutions = AccountTemplate.templateSubstitutionsFor(userAccount, host)
   ...
   * @return {Object}
   */
  static templateSubstitutionsFor (userAccount, host) {
