...
const NotificationsManager = require('./models/notifications-manager')
...
function createApp (argv = {}) {
  ...
  console.log('argv.notMgr in create-app', argv.notMgr)
  argv.notMgr = argv.notMgr ? new NotificationsManager() : argv.notMgr
