...
module.exports = class Provider {
  ...
  authenticate () {
    ...
    router.use('/',
      ...
      (req, res, next) => {
        ...
        client.verifier(verifyOptions)(req, res, next)
      })
    return router
  }
  ...
  middleware (corsSettings) {
    ...
    router.get('/rp',
      authRp)
    // router.get('/rp', this.authenticate.bind(this),
    //   this.authSessionInit.bind(this), authRp)
    // router.get('/rp', (req, res, next) => {
    //   debug.oidc('Starting /rp')
    //   Promise.resolve()
    //     .then(() => {
