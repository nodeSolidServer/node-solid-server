...
const MagicLinkEmailRequest = require('../../requests/magic-link-email-request')
...
function middleware (oidc) {
  ...
  router.get('/login/magic-link', LoginRequest.loginMagicLink)

  router.get('/sharing', SharingRequest.get)
  router.post('/sharing', bodyParser, SharingRequest.share)

  router.get('/magic-link/generate', restrictToTopDomain, MagicLinkEmailRequest.get)
  router.post('/magic-link/generate', restrictToTopDomain, bodyParser, MagicLinkEmailRequest.post)
