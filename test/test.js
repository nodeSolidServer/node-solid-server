...
describe('Root container', function() {
    it('Should exists (return 200 on GET)', function(done) {
        server.get('/')
            .expect(200, done);
    });
...
describe('Content-type supports', function() {
    describe('HTML support', function() {
        it('Should return the HTML file on GET', function(done) {
