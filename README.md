...
The [solid test suite](https://github.com/nodeSolidServer/node-solid-server/blob/main/test/surface/run-solid-test-suite.sh) is ran as part of GitHub Actions on this repository, so this ensures that this server is always (to the best of our knowledge) fully spec compliant.
